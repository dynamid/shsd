...
def parselog(maillog):
    ...
    for line in maillog:
        ...
        year = date[0].split('/')[2]
        accounts.add(""+ip+":!:"+user+":!:"+months[month]+":!:"+day+":!:"+year) #append({'user' : user, 'ip' : ip})
    #print(accounts)
    return accounts
...
def jsonify(accounts):
    ...
    for account in accounts:
        ...
        res.append({'ip':newaccount[0], 'user': newaccount[1], 'month': newaccount[2], 'day': newaccount[3], 'year': newaccount[4]})
